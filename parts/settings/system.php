...
//KM: I'll move these functions into the main wp-helpers file when the SAVE button is removed.
// Just easier to keep all this code here for now.
...
function clean_phpinfo()
{
  ...
  $pinfo = str_ireplace('width="600"','class="form-table"',$pinfo);
